...
- `SPOTIFY_CLIENT_SECRET`: Spotify API 클라이언트 시크릿
- `SPOTIFY_REDIRECT_URI`: Spotify API 리다이렉트 URI
- `SPOTIFY_PLAYLIST_ID`: 업데이트할 Spotify 플레이리스트 ID
